...
import com.bootcamp.ws.infrastructure.common.exceptions.NotFoundException;
...
//                .collectList()
//                .map(technologies -> new CapabilityWithTechnologiesResponseDto.Builder()
//                        .capabilityId(capId)
//                        .technologiesIds(technologies.stream()
//                                .map(tech -> new TechnologyResponseDto.Builder()
//                                        .id(tech.getId())
//                                        .name(tech.getName())
//                                        .build())
//                                .collect(Collectors.toList()))
